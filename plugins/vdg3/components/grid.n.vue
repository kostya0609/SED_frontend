<script>
import Column from '@/plugins/vdg3/components/column.vue';
...
export default {
    ...
    setup(props, context){
        ...
        function click_context_item(fn, event, row){
            context.emit('eventContext', fn, event, row);
        };

        return {grid, click_context_item};
    },
                            ...
                            return h(
                                'div',
                                {
                                    ...
                                    onClick : $event => {
                                        ...
                                        this.click_context_item(el.function, $event, this.grid.system.context.row);
