...
import {useUserRepo, useDepartmentRepo, useAdditionalRightRepo} from "@/plugins/access/repositories";
...
const DepartmentRepo = useDepartmentRepo();
const AdditionalRightRepo = useAdditionalRightRepo();
